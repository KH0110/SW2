...
#define _DUTY_MAX 2121 // 2000
#define _DUTY_NEU 1421 // 1500
#define _DUTY_MIN 1001 // 1000

#define _SERVO_ANGLE_DIFF  122  // Replace with |D - E| degree
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(80, 0.5, 0));
...
float volt_to_distance(int a_value)
{
  ...
  return 651 + (-2.99 * a_value) + (5.54E-03 * a_value * a_value) + (-3.95E-06 * a_value * a_value * a_value);
}
